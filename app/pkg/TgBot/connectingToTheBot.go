	...
	for update := range updates {
		if update.Message != nil {
			...
			case "/start":
				...
				msg := tgbotapi.NewMessage(update.Message.Chat.ID, "👋Добро пожаловать! Я — ваш финансовый помощник.\nБлагодаря мне у вас есть возможность взять свои денежные средства под контроль. Вперёд к финансовому успеху!\nВыберите действие в меню ✏\n\nБазовые команды бота:\n/info - Информация о боте\n/help - Помощь по использованию бота")
